...
import { MsgDeleteCV } from "./types/cvproject/tx";
import { MsgCreateCV } from "./types/cvproject/tx";


const types = [
  ["/alexs778.cvproject.cvproject.MsgUpdateCV", MsgUpdateCV],
  ["/alexs778.cvproject.cvproject.MsgDeleteCV", MsgDeleteCV],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgDeleteCV: (data: MsgDeleteCV): EncodeObject => ({ typeUrl: "/alexs778.cvproject.cvproject.MsgDeleteCV", value: MsgDeleteCV.fromPartial( data ) }),
