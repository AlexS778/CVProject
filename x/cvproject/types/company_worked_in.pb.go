...
func (m *CompanyWorkedIn) GetCompanyID() string {
	if m != nil {
		return m.CompanyID
	}
	return ""
...
var fileDescriptor_464f8df6d607866b = []byte{
	...
	0xcc, 0x49, 0xad, 0x28, 0x36, 0x37, 0xb7, 0xd0, 0x83, 0xab, 0x45, 0xb0, 0x94, 0x9e, 0x33, 0x72,
	...
	0xfc, 0x12, 0x73, 0x53, 0x25, 0x98, 0xc0, 0x52, 0xc8, 0x42, 0x42, 0x32, 0x5c, 0x9c, 0x50, 0xae,
	0xa7, 0x8b, 0x04, 0x33, 0x58, 0x1e, 0x21, 0x20, 0xa4, 0xc6, 0xc5, 0x57, 0x92, 0x99, 0x9b, 0x5a,
	0x5c, 0x92, 0x98, 0x5b, 0x10, 0x5c, 0x92, 0x58, 0x54, 0x22, 0xc1, 0x02, 0x56, 0x82, 0x26, 0x2a,
	0xa4, 0xc4, 0xc5, 0x03, 0x17, 0x71, 0xcd, 0x4b, 0x91, 0x60, 0x05, 0xab, 0x42, 0x11, 0x13, 0x92,
	0xe2, 0xe2, 0x48, 0xce, 0xcf, 0xcd, 0x4d, 0xcd, 0x2b, 0x29, 0x96, 0x60, 0x03, 0xcb, 0xc3, 0xf9,
	0x42, 0x12, 0x5c, 0xec, 0xc9, 0x45, 0xa9, 0x89, 0x25, 0xf9, 0x45, 0x12, 0xec, 0x60, 0x29, 0x18,
	...
	0x4b, 0x32, 0x4a, 0x93, 0xf4, 0x92, 0xf3, 0x73, 0xf5, 0x1d, 0x73, 0x52, 0x2b, 0x82, 0xcd, 0xcd,
	0x2d, 0xf4, 0x9d, 0xc3, 0x02, 0xa0, 0x01, 0x5b, 0xa1, 0x8f, 0x08, 0xe4, 0x92, 0xca, 0x82, 0xd4,
	0xe2, 0x24, 0x36, 0x70, 0xc8, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xa5, 0xa8, 0xcd, 0x59,
	0x7e, 0x01, 0x00, 0x00,
}
...
func (m *CompanyWorkedIn) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CompanyID) > 0 {
		...
		i = encodeVarintCompanyWorkedIn(dAtA, i, uint64(len(m.CompanyID)))
		i--
		dAtA[i] = 0x1a
	}
